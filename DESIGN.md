...
- [ ] Dynamic vertex buffer resizing or multi-batch support for complex scenes
- [ ] Add integration tests comparing rendered screenshots across backends

### Phase 3: Extended Primitives

- [ ] Rounded rectangles
- [ ] Arcs and bezier curves (tessellated to triangles)
- [ ] Concave polygon fill (ear-clipping triangulation)
- [ ] Draw order / z-layers within a frame
- [ ] Clipping rectangles (scissor rect)

### Phase 4: Textures and Text

- [ ] Texture loading and textured quads
- [ ] Bitmap font rendering (texture atlas + quads)
- [ ] SDF text rendering for resolution-independent text
- [ ] Sprite / image drawing API on Canvas

### Phase 5: Performance

- [ ] Persistent vertex buffer with dirty tracking (avoid full rewrite each frame)
- [ ] Multiple pipelines for different blend modes
- [ ] Instanced rendering for repeated geometry (particles, tiles)
- [ ] Render target caching for static content
